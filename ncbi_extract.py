"""
Updated 3/23/2026 by leahbriscoe830 Leah Briscoe and jcapecci09 Jimmy Capecci

ncbi_extract_merged.py: Takes a template txt named proteinSearch.txt as input and extracts the search parameters to 
